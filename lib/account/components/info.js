      ...
      <div className='account-information-page'>
        <div>
          ...
          <dl className='row inset-panel padded'>
            ...
            <dd className='col-xs-10'>
              <a href='http://platformio.org/pricing?utm_source=ide&utm_medium=atom&utm_campaign=page' className='inline-block'>
                { this.props.info.currentPlan }
              </a>
              { this.props.info.upgradePlan &&
                <a className='inline-block btn btn-primary' href='http://platformio.org/pricing?utm_source=ide&utm_medium=atom&utm_campaign=page'>UPGRADE</a> }
              { this.props.info.upgradePlan &&
