      ...
      <div className='native-key-bindings' tabIndex='1'>
        ...
        <form onSubmit={ ::this.onComplete }>
          ...
          <div className='block text-right'>
            <button onClick={ ::this.onCancel } className='inline-block btn btn-lg'>Cancel</button>
            <button onClick={ ::this.onComplete } className='inline-block btn btn-lg btn-primary'>
              Complete
            </button>
          </div>
        </form>
