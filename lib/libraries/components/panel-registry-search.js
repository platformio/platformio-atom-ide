...
class LibRegistrySearchView extends BaseView {
...
class LibSearchResultItem extends BaseView {
  ...
  render() {
    return (
      <div onclick={ (e) => this.onDidShow(e, this.props.data.id) } className='block list-item-card'>
        <div className='row'>
