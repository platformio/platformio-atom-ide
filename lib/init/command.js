...
import {getPlatformIOExecutable, runAtomCommand} from '../utils';
...
export function command() {
  ...
  view.handleInit = () => {
    ...
    projectPaths.forEach((path) => {
      ...
      const initResult = child_process.spawnSync(getPlatformIOExecutable(), args);
  ...
  const boardsResult = child_process.spawnSync(getPlatformIOExecutable(), boardsArgs);
