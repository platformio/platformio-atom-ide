...
import {runAtomCommand, spawnPio, getBoards, isFile} from '../utils';
...
export function command() {
  ...
  view.handleInit = () => {
    ...
    return installPlatformsForBoards(selectedBoards, getBoards(), view)
...
export function installPlatformsForBoards(boardIds, boardsInfo, view) {
  ...
  for (const platform of getPlatforms(boardIds, boardsInfo)) {
