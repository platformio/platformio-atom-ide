      ...
      <div className='pane-item home-app'>
        <div className='menu'>
          <ul className='nav nav-pills nav-stacked'>
            { routes.map(item => (
                <li onClick={ () => goTo(router.history, item.path) } className={ getActiveRoute(routes, router.route.location) === item ? 'selected' : '' }>
          ...
          <div className='topbar-container'>
            <div className='row'>
              ...
              <div className='col-xs text-right'>
                <span className='icon icon-person'>Developer Preview</span>
              </div>
            </div>
          </div>
