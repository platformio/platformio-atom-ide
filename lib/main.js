...
import {installCommands, serialMonitor, openTerminal} from './maintenance';
...
module.exports = {
  ...
  activate: function(state) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'platformio-ide:miantenance.installCommands': () => installCommands(),
      'platformio-ide:miantenance.serialMonitor': () => serialMonitor(),
      'platformio-ide:miantenance.openTerminal': () => openTerminal(),
