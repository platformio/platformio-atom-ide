...
module.exports = {
  ...
  setupCommands: function() {
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'platformio-ide:maintenance.rebuild-index': () => {
        ...
        if (p === NO_ELIGIBLE_PROJECTS_FOUND) {
          atom.notifications.addError('None of open directories is a PlatformIO project.', {
    ...
    // TODO: also trigger this on init and import from Arduino IDE explicitly.
    // User may convert an open project into a PlatformIO project without changing paths. 
