...
module.exports = {
  ...
  activate: function(state) {
    ...
    for (let target of ['Build', 'Upload', 'Clean']) {
      this.subscriptions.add(atom.commands.add('atom-workspace', `platformio-ide:target:${target.toLowerCase()}`, () => {
  ...
  consumeToolBar: function(toolBar) {
    ...
    this.toolBar.addButton({
      ...
      tooltip: 'Initialize PlatformIO based Project or update existing...'
    });
