...
module.exports = {
  ...
  activate: function(state) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'platformio-ide:maintenance.libmanager-cli': () => openTerminal('platformio lib --help'),
      ...
      'platformio-ide:maintenance.serial-ports': () => openTerminal('platformio serialports list'),

      'platformio-ide:maintenance.open-terminal': () => openTerminal('platformio --help'),

      'platformio-ide:maintenance.install-commands': () => installCommands(),
      'platformio-ide:maintenance.update-platformio': () => openTerminal('platformio update'),
      'platformio-ide:maintenance.upgrade-platformio': () => openTerminal('platformio upgrade'),
