...
import {installCommands, openTerminal} from './maintenance';
import {PlatformioBuildProvider} from './build-provider';
import {runAtomCommand, updateOSEnviron} from './utils';
...
module.exports = {
  ...
  activate: function(state) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'platformio-ide:maintenance.serialMonitor': () => openTerminal('platformio -c atom serialports monitor'),
      'platformio-ide:maintenance.serialPorts': () => openTerminal('platformio -c atom serialports list'),

      'platformio-ide:maintenance.installCommands': () => installCommands(),
      'platformio-ide:maintenance.updatePlatformIO': () => openTerminal('platformio -c atom update'),
      'platformio-ide:maintenance.upgradePlatformIO': () => openTerminal('platformio -c atom upgrade'),
