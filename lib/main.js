...
import {installCommands, openTerminal, updateOSEnviron, onActivate} from './maintenance';
...
module.exports = {
  ...
  activate: function(state) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'platformio-ide:maintenance.serialMonitor': () => openTerminal('platformio serialports monitor'),
    ...
    atom.workspace.observeTextEditors((editor) => {
      if (['.ino', '.pde'].indexOf(path.extname(editor.getPath())) !== -1 ) {
