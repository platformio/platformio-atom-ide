...
import { checkDevelopmentUpdates, reinstallPIOCore } from './installer/helpers';
import { consumePlatformioIDETerminal, runCmdsInTerminal } from './terminal';
import { getActivePioProject, synchronizeRecentProjects } from './project/helpers';

import { CompositeDisposable } from 'atom';
import HomeIndex from './home/index';
import InstallationManager from './installer/manager';
import PlatformIOBuildProvider from './services/build-provider';
...
class PlatformIOIDEPackage {
  ...
  constructor() {
    ...
    this.consumePlatformioIDETerminal = consumePlatformioIDETerminal;
