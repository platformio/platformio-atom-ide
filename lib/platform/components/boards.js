...
export default class Boards extends React.Component {
  ...
  static propTypes = {
    items: React.PropTypes.arrayOf(React.PropTypes.shape({
      ...
      frameworks: React.PropTypes.arrayOf(React.PropTypes.shape({
        name: React.PropTypes.string.isRequired,
        title: React.PropTypes.string.isRequired,
      })).isRequired,
      mcu: React.PropTypes.string.isRequired,
      fcpu: React.PropTypes.number.isRequired,
      rom: React.PropTypes.number.isRequired,
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className='text'>
          <span className='icon icon-bug'></span><a href='http://docs.platformio.org/page/plus/debugging.html'>The Unified Debugger</a>: mouse over the icon to list available debugging tools or check which are already on a board.
        </div>
        <br />
