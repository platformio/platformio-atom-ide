...
export function notifyExtensionIsDeprecated() {
  ...
  atom.confirm({
    ...
    detailedMessage: 'According to the user feedback, PlatformIO IDE for Atom has basic integration with PlatformIO ecosystem. ' +
      ...
      'You existing PlatformIO projects are fully compatible and do not require any changes!',
    buttons: {
      'Try VSCode': () => {
        utils.openUrl('https://platformio.org/platformio-ide');
      },
