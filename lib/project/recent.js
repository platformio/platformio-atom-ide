...
export default class RecentProjects extends EtchComponent {
...
class RecentProjectsView extends EtchComponent {
  ...
  render() {
    ...
    return (
      <atom-panel>
        ...
        <ul className='background-message text-center'  style={ { display: !items.length ? 'block' : 'none' } }>
          <li>
            No recent projects
          </li>
        </ul>
